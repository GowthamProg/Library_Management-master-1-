...
import RegisterPage from "./sections/auth/register/RegisterPage"; // Import your RegisterPage component
...
export default function Router() {
  ...
  const adminRoutes = useRoutes([
    ...
    {
      path: "register",  // Add register route for admin
  ...
  const memberRoutes = useRoutes([
    ...
    {
      path: "register",  // Add register route for members
      element: <RegisterPage />
    },
    {
      path: "404",
  ...
  const guestRoutes = useRoutes([
    ...
    {
      path: "register",  // Add register route for guests
      element: <RegisterPage />
    },
    {
      path: "404",
